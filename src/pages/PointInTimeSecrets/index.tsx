...
const staticPitData: PointInTimeData[] = [
  ...
  },
  {
    ...
    change_request_message:
      "Updated JWT_SECRET for enhanced security compliance",
...
const PointInTime = () => {
  ...
  const [isViewPitChangesModalOpen, setIsViewPitChangesModalOpen] =
    useState(false);
  const [selectedPitData, setSelectedPitData] = useState<PointInTimeData>(
    staticPitData[0]
  );
            ...
            <div className="space-y-2">
              ...
              <div className="text-white">
                <p className="font-medium">
                  {formatDate(selectedPitData.created_at).date}
                </p>
                <p className="text-slate-400 text-sm">
                  {formatDate(selectedPitData.created_at).time}
                </p>
              </div>
            </div>
            <div className="space-y-2">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">
                  Complete timeline of environment changes
                </p>
              </div>
            </div>
            <Badge
